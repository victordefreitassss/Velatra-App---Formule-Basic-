...
export const FeatureLockedMessage: React.FC<FeatureLockedMessageProps> = ({ title }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 page-transition">
      <Card className="max-w-md w-full bg-white border border-zinc-200 p-10 flex flex-col items-center">
        <div className="w-20 h-20 bg-zinc-400/10 rounded-full flex items-center justify-center mb-6">
