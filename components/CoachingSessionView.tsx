    ...
    <div className="fixed inset-0 z-50 bg-zinc-950 text-white flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold text-velatra-accent uppercase tracking-widest">Coaching Live</h2>
            <p className="text-lg font-black leading-none">{member.name}</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          {isResting && (
            <div className="flex items-center gap-2 bg-velatra-accent/20 text-velatra-accent px-3 py-1.5 rounded-full animate-pulse">
              <ClockIcon size={16} />
            ...
            return (
              <div key={idx} className="snap-center shrink-0 w-64 relative group">
                ...
                >
                  ...
                  <p className="text-xs text-zinc-400 mt-1">{ex.sets} x {ex.reps}</p>
                </button>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
            ...
            <div className="bg-zinc-900 rounded-3xl p-4 border border-zinc-800">
              ...
              <div className="space-y-3">
                {Array.from({ length: numSets }).map((_, setIdx) => {
                  ...
                  return (
                    <div key={setIdx} className={`grid grid-cols-[auto_1fr_1fr_auto] gap-4 items-center p-2 rounded-2xl transition-colors ${isDone ? 'bg-emerald-500/10' : 'bg-zinc-800/50'}`}>
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1">
              ...
              <input 
                ...
                className="w-full accent-velatra-accent"
              />
            </div>
            <div className="text-right">
          ...
          >
            ...
            <div className="w-full max-w-md aspect-[9/16] bg-zinc-900 border border-zinc-800 rounded-3xl flex flex-col items-center justify-center relative overflow-hidden">
              ...
              <div className="relative z-10 text-center p-6">
                ...
                <p className="text-sm text-zinc-400 mb-6">Enregistrez la série pour une analyse biomécanique détaillée et une comparaison avec les séances précédentes.</p>
