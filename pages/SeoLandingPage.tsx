...
export default function SeoLandingPage() {
  ...
  return <>
    ...
    <main className="marketing-seo-page">
      <section className="marketing-seo-hero"><div className="marketing-container"><nav className="marketing-breadcrumb" aria-label="Fil d’Ariane"><Link to="/">Accueil</Link><span>/</span><Link to="/fonctionnalites">Velatra</Link><span>/</span><span>{page.title.split(':')[0]}</span></nav><span className="marketing-kicker"><span className="marketing-kicker-dot" /> VOTRE ACTIVITÉ DE COACHING</span><h1>{page.shortTitle}</h1><p>{page.intro}</p><div className="marketing-hero-actions"><Link to="/contact" className="marketing-button marketing-button-primary">Demander un accès bêta <ArrowRight size={16} /></Link><Link to="/contact" className="marketing-button marketing-button-secondary">Demander une démonstration</Link></div><div className="marketing-seo-proof"><div><b>01</b><span>Un espace pour<br />vos adhérents</span></div><div><b>02</b><span>Les outils pour<br />vos programmes</span></div><div><b>03</b><span>Une vue plus claire<br />sur votre activité</span></div></div></div></section>
