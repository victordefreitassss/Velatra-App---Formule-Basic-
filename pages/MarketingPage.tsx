  ...
  return (
    <div className="space-y-8 page-transition pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-1">
        <div>
          <h1 className="text-4xl font-display font-bold tracking-tight text-white leading-none">Marketing</h1>
          <p className="text-[10px] text-velatra-textDark font-bold uppercase tracking-[3px] mt-2">Automatisations Emails & SMS</p>
        </div>
      ...
      <Card className="p-8 text-center bg-white/5 border-dashed border-white/10">
        <MegaphoneIcon size={48} className="mx-auto text-velatra-textMuted mb-4" />
        <h3 className="text-xl font-bold text-white mb-2">Marketing en construction</h3>
