...
import { 
  ArrowRight, Play, Dumbbell, Users, Check, Sparkles, Apple, Smartphone, Zap
} from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            <motion.div
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 bg-zinc-50 border border-zinc-200/60 rounded-full"
            >
            ...
            <motion.h1
              ...
              className="text-4.5xl sm:text-5xl md:text-5.5xl font-display font-bold tracking-tight leading-[1.08] text-zinc-950"
            >
              Votre club.<br />
              <span className="text-emerald-505 bg-gradient-to-r from-emerald-600 to-emerald-500 bg-clip-text text-transparent">Directement dans leur poche.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-zinc-500 max-w-md mx-auto lg:mx-0 leading-relaxed font-normal"
            >
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row items-stretch justify-center lg:justify-start gap-3.5 pt-2"
            >
              <a
                href="/register"
                onClick={(e) => {
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-center lg:justify-start items-center gap-x-5 gap-y-1 text-zinc-400 text-[11px] font-medium pt-2"
            >
                    ...
                    <AnimatePresence mode="wait">
                      {activeTab === 'workouts' && (
                        ...
                        >
                          <div className="bg-white p-3 rounded-xl border border-zinc-200/50 flex justify-between items-center shadow-sm">
                            <div>
                              <span className="text-[7px] font-mono uppercase tracking-wider text-zinc-400 block">SÉANCE D'AUJOURD'HUI</span>
                      ...
                      {activeTab === 'nutrition' && (
                        <motion.div
                          ...
                          className="space-y-3"
                        >
                          <div className="space-y-1.5 bg-white p-3 border border-zinc-200/50 rounded-xl shadow-sm font-sans">
                          ...
                          <div className="grid grid-cols-3 gap-1.5 bg-white p-2 rounded-xl border border-zinc-100 shadow-sm font-sans">
                            ...
                            <div className="text-center border-x border-zinc-100 font-sans">
                      ...
                      {activeTab === 'crm' && (
                        ...
                        >
                          {leads.map((lead) => (
                            <div 
                              key={lead.id} 
                              className="bg-white border border-zinc-200/50 px-2.5 py-1.5 rounded-lg flex items-center justify-between shadow-sm font-sans"
                            >
                              <div>
                              ...
                              <button
                                ...
                                className={`h-6 px-2 rounded text-[8px] font-bold uppercase tracking-wider transition-all leading-none ${
                                  lead.contacted 
                                    ? 'bg-zinc-50 text-zinc-400 cursor-not-allowed border border-zinc-105' 
